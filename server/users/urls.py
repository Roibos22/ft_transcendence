...
urlpatterns = [
    ...
    path('profile/<str:username>/delete/', delete_user, name='delete_user'), # I actually don't need user_id?
	path('profile/<str:username>/update/', update_user, name='update_user') # I actually don't need user_id?
