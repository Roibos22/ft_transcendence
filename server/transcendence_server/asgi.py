...
from live_games.consumers.multiplayer_game_consumer import MultiplayerGameConsumer
...
application = ProtocolTypeRouter({
    ...
    "websocket": URLRouter([
        ...
        re_path(r'ws/multiplayer_game/(?P<game_id>\w+)/$', MultiplayerGameConsumer.as_asgi()),
